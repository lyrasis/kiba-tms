...
Boolean setting. Defaults to `false`. Migration specialist will change to `true` when you have completed xref:../location_temptext_mapping_worksheet[location `temptext` review/mapping].
