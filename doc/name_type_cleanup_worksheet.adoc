...
This page is about the name type review/cleanup worksheet provided to clients as Phase 1 of name cleanup. For an overview of the name cleanup workflow, see: xref:name_cleanup_workflow_overview.adoc[Name cleanup workflow overview]
