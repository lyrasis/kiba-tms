...
RSpec.describe Kiba::Tms::Transforms::ThesXrefs::ForConstituentsTreatmentMergerDeathDissolutionPlace do
  ...
  describe "#process" do
    ...
    context "when no target value" do
      ...
      context "with null source" do
        ...
        let(:expected) do
          {
            term_death_dissolution_place_preferred: "b",
            term_death_dissolution_place_used: "a",
            term_death_dissolution_place_note: "%NULLVALUE%"
          }
        end
        ...
        let(:expected) do
          {
            ...
            term_death_dissolution_place_used: "a|d",
            term_death_dissolution_place_note: "%NULLVALUE%|e"
          }
        end
