...
RSpec.describe Kiba::Tms::Transforms::ConAddress::RemoveRedundantAddressLines do
  ...
  let(:input) do
    [
      ...
      {alphasort: "g, h", displayname: "h g", displayname1: "hg",
       displayname2: "g, h"},
      {alphasort: "i, j", displayname: "j i", displayname1: "j i",
       displayname2: "ij"},
      {alphasort: "k, l", displayname: "l k", displayname1: "bar",
       displayname2: "bats!"}
    ]
  end
  ...
  let(:expected) do
    [
      ...
      {alphasort: "g, h", displayname: "h g", displayname1: "hg",
       displayname2: nil},
      {alphasort: "i, j", displayname: "j i", displayname1: nil,
       displayname2: "ij"},
      {alphasort: "k, l", displayname: "l k", displayname1: "bar",
       displayname2: "bats!"}
    ]
