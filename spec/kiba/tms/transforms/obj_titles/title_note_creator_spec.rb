...
RSpec.describe Kiba::Tms::Transforms::ObjTitles::TitleNoteCreator do
  ...
  let(:input) do
    [
      ...
      {remarks: "remark", dateeffectiveisodate: "1982", titletype: "former",
       title: "blah"},
      {remarks: nil, dateeffectiveisodate: "1982", titletype: "former",
       title: "blah"},
      {remarks: "remark", dateeffectiveisodate: "1982", titletype: nil,
       title: "blah"},
      {remarks: nil, dateeffectiveisodate: "1982", titletype: nil,
       title: "blah"}
    ]
  end
