  ...
  module Tms
    module ConXrefs
      ...
      setting :for_objects, reader: true do
        ...
        # list of con_xref roles controlling merge into assoc person/org field
        #   of object record
        setting :assoc_con_roles, default: %w[], reader: true
        # list of con_xref roles controlling merge into objectproduction
        #   person/org field of object record
