        ...
        module FromObjectDepartments
          ...
          def xforms
            Kiba.job_segment do
              ...
              transform Cspace::NormalizeForID, source: :department, target: :norm
              transform Rename::Field, from: :department, to: :termdisplayname
              transform Merge::ConstantValue, target: :worktype, value: 'Collection, Internal use'
              transform Merge::ConstantValue, target: :termsource, value: 'TMS Objects.department'
            end
          end
        end
      end
