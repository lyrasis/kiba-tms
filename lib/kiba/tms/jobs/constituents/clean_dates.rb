          ...
          def xforms
            Kiba.job_segment do
              transform Delete::FieldsExcept,
                fields: %i[constituentid displaydate begindateiso enddateiso
                  nationality]
              ...
              unless Tms::Constituents.displaydate_cleaners.empty?
                ...
                transform FilterRows::AnyFieldsPopulated, action: :keep,
                  fields: %i[begindateiso enddateiso datenote]
                transform Tms::Transforms::Constituents::ReshapeCleanedDates
                transform Merge::ConstantValue, target: :datasource,
                  value: "Constituents.displaydate_begindateiso_enddateiso"
              end
            end
          end
        end
