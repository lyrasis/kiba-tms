...
#
# Refer to {Kiba::Tms::AltNumsForObjTypeCleanup} as an example config
#   module extending this mixin module in a simple way. See
#   {Kiba::Tms::PlacesCleanupInitial} for a more complex usage with
...
module Kiba::Tms::Mixins::IterativeCleanupable
  ...
  def self.check_required_settings(mod)
    %i[base_job job_tags worksheet_add_fields
  ...
  def cleaned_uniq_job_hash(mod)
    {
      ...
      creator: {
        callee: Tms::Jobs::IterativeCleanup::CleanedUniq,
        args: {mod: mod}
      },
      tags: mod.job_tags
    }
  ...
  def returned_compiled_job_hash(mod)
    {
      path: File.join(Tms.datadir, "working",
        "#{mod.cleanup_base_name}_returned_compiled.csv"),
      creator: {
        callee: Tms::Jobs::IterativeCleanup::ReturnedCompiled,
        args: {mod: mod}
      },
      tags: mod.job_tags
    }
  ...
  def corrections_job_hash(mod)
    {
      path: File.join(Tms.datadir, "working",
        "#{mod.cleanup_base_name}_corrections.csv"),
      creator: {
        callee: Tms::Jobs::IterativeCleanup::Corrections,
        args: {mod: mod}
      },
      tags: mod.job_tags,
