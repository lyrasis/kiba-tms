      ...
      module Constituents
        class AppendDatesToNames
          ...
          def initialize
            ...
            @appendable = Kiba::Tms.config.constituents.date_append.to_types
            @date_sep = Kiba::Tms.config.constituents.date_append.date_sep
            @name_date_sep = Kiba::Tms.config.constituents.date_append.name_date_sep
            @date_suffix = Kiba::Tms.config.constituents.date_append.date_suffix
          end
