      ...
      module Loansin
        class InsuranceIndemnityNote
          def initialize(target: :insind)
            @target = target
            @sources = %i[insurancefromlender insurancefrompreviousvenue insuranceatvenue insurancereturn
                          indemnityfromlender indemnityfrompreviousvenue indemnityatvenue indemnityreturn]
